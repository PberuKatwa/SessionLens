...
function scoreLabel(metric: string, score: number): string {
...
function scoreDescription(metric: string, score: number): string {
...
function SectionHeader({ number, label, isLime = false }: { number: string; label: string; isLime?: boolean }) {
  return (
