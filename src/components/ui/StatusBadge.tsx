...
export function RiskStatusBadge({ value }: RiskStatusBadgeProps) {
  ...
  if (value === false) {
    return (
      <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-lg text-xs font-extrabold border-2 border-red-500 bg-red-50 text-red-700 shadow-sm shadow-red-100">
  ...
  // NOT EVALUATED
  return (
    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold border border-gray-300 bg-gray-100 text-gray-600">
